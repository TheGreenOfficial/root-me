...
**There we go, we are now logged in as superadmin and learned that developer should never user loose comparison "==" and we should not pass untrusted user input to unzerialize().**
