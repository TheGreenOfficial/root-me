...
**After refreshing the page and we are now logged in as superadmin..**
...
**We learned that developer should never user loose comparison "==" and we should not pass untrusted user input to unzerialize().**


**That was the challenge you can use this "NoUserInputInPHPSerialization" as flag/passwd to validate.**<br>
**Thankyou.**
