...
**We will open brupsuite to analyze request while we upload files and try to bypass the file upload logic and insted of image we will upload php files to run arbitrary commands on server.**
