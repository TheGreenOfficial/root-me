...
**Now we can see that username is admin but the password is .passwd content itself so we should directly fetch .passwd file which is our flag using this payload:**
