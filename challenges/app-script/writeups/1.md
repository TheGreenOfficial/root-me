...
**After that cd to users home ~ dir and run the binary using ./ch11 or bash ch11 whatever you prefer and ls will not work now in current tty cuz our custom one is there and it will run. Don't get confused and cd works because its not a binary in /bin/ its inbuild into shell maybe for faster execution I guess..**
