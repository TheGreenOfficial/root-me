...
**It worked because bash executable/shell takes arguments and `<<<` this in bellow example is stdin in bash and we did the same thing alike bellow using python automation up there while bash was popping up.**

<br>
<img width="1316" height="276" alt="image" src="https://github.com/user-attachments/assets/b78581b3-ed99-44c7-9ac8-5a119ab32b64" />
<br>
<br>
