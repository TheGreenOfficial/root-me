...
```
<br><br>
**- The stack grows downward** <br>
**- Writing past the end of `buf` overwrites memory at higher addresses** <br>
**- The next variable is `check`** <br>
