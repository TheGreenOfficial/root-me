...
**In the code you can see that defined buffer to take input is 40 bytes but giving fgets() 45 bytes so if we provide it stuffs of 40 bytes then the first if contidion triggers.**
